...
combineTool.py -M Impacts -d ../Datacards/datacard_$i.root -m 125 --doInitialFit -P r --rMin=0. --rMax=0.1 -t -1 --expectSignal=0.0059 --parallel 16
combineTool.py -M Impacts -d ../Datacards/datacard_$i.root -m 125 --doFits -t -1 --expectSignal=0.0059 --parallel 16 --autoBoundsPOIs r
#--autoBoundsPOIs
#--rMin=$lower --rMax=$upper
#--robustFit 1
combineTool.py -M Impacts -d ../Datacards/datacard_$i.root -m 125 -o impacts_$i.json -t -1 --expectSignal=0.0059
