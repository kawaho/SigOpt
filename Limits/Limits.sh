combineCards.py Name1=../Datacards/datacard_ggcat0.txt Name2=../Datacards/datacard_ggcat1.txt Name3=../Datacards/datacard_ggcat2.txt Name4=../Datacards/datacard_ggcat3.txt Name5=../Datacards/datacard_vbfcat0.txt Name6=../Datacards/datacard_vbfcat1.txt Name7=../Datacards/datacard_vbfcat2.txt Name8=../Datacards/datacard_vbfcat3.txt > ../Datacards/datacard_comb.txt
...
combine -M AsymptoticLimits -m 125 ../Datacards/datacard_vbfcat3.txt --run blind #--freezeParameters pdfindex_ggcat1_13TeV
mv higgsCombineTest.AsymptoticLimits.mH125.root higgsCombineTest.AsymptoticLimits.vbfcat3.mH125.root
