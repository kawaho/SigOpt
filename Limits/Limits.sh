combineCards.py Name1=../Datacards/datacard_ggcat0.txt Name2=../Datacards/datacard_ggcat1.txt Name3=../Datacards/datacard_ggcat2.txt Name5=../Datacards/datacard_vbfcat0.txt Name6=../Datacards/datacard_vbfcat1.txt > ../Datacards/datacard_comb.txt
